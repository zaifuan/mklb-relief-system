...
import { getPublicOptions, createAbsence, checkPublic, cancelPublic, getAbsence, getPublicSchedule } from '../controllers/absence.controller.js';
...
router.get('/public/schedule', getPublicSchedule); // jadual guru utk Pertukaran Kelas
